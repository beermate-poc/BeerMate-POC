       ...
       actionCall.setParams({recordTypeID:recTypeId});
        actionCall.setCallback(this, function(response) {
            ...
            if (stateValue === "SUCCESS") {
                ...
                if(!component.get("v.isCreate") && component.find("EngbrandSearch") && (component.get("v.newObjective.RecordType.Name") == 'Feature' || component.get("v.newObjective.RecordType.Name") == 'Display')){
                ...
                //Added this method to fetch Subtype from Planned Objective when Subtype is not populated in Edit mode even when PlannedObjective is present
                if(!component.get("v.isCreate") && component.get("v.newObjective.Planned_Objective__c") != null && component.get("v.newObjective.Sub_Type__c") == null ){
                    
                    helper.populateSubTypeValues(component,component.get("v.newObjective.Planned_Objective__c"),component.get("v.newObjective.RecordType.Name"),event);
