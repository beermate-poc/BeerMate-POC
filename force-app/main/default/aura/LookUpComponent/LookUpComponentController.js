({
    searchField : function(component, event, helper) {
        ...
        var PricebookValue = component.get("v.PricebookValue");
        var fieldName1 = component.get("v.fieldName1");
        console.log("currentText" +currentText);
        console.log("PricebookValue" +PricebookValue);
        ...
        action.setParams({
            ...
            "fieldName1" : component.get("v.fieldName1"),
    ...
    setSelectedRecord : function(component, event, helper) {
        ...
        //console.log("selectRecordName" + component.get("v.selectRecordName"));
